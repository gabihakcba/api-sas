-- CreateEnum
CREATE TYPE "ESTADO_TEMARIO" AS ENUM ('PENDIENTE', 'EN_TRATAMIENTO', 'TRATADO', 'POSPUESTO');

-- CreateEnum
CREATE TYPE "ACTION" AS ENUM ('CREATE', 'READ', 'UPDATE', 'DELETE', 'MANAGE');

-- CreateEnum
CREATE TYPE "RESOURCE" AS ENUM ('CUENTA', 'MIEMBRO', 'PROTAGONISTA', 'ADULTO', 'RESPONSABLE', 'AREA', 'RAMA', 'EVENTO', 'INSCRIPCION', 'PAGO', 'PRESUPUESTO', 'INVENTARIO', 'PLAN_FORMACION', 'ASISTENCIA', 'CERTIFICADO', 'CUENTA_DINERO', 'TIPO_EVENTO', 'LIBRO_ACTAS', 'LOG', 'ACTION', 'ROLE', 'RELACION', 'CONCEPTO_PAGO', 'METODO_PAGO', 'COMISION', 'PARTICIPANTE_COMISION', 'CONSEJO', 'ASISTENCIA_CONSEJO');

-- CreateEnum
CREATE TYPE "SCOPE" AS ENUM ('GRUPO', 'RAMA', 'AREA', 'GLOBAL', 'OWN');
...
CREATE TABLE "Evento" (
    ...
    "costo_mp" DECIMAL(15,2) NOT NULL,
    "costo_ma" DECIMAL(15,2) NOT NULL,
    "costo_ayudante" DECIMAL(15,2) NOT NULL,
    "borrado" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "RamaAfectada" (
    ...
    CONSTRAINT "RamaAfectada_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "TemarioConsejo" (
    ...
    "estado" "ESTADO_TEMARIO" NOT NULL DEFAULT 'PENDIENTE',
    "borrado" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "id_consejo" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Responsabilidad_id_protagonista_id_responsable_key" ON "Responsabilidad"("id_protagonista", "id_responsable");
...
-- CreateIndex
CREATE UNIQUE INDEX "Pago_codigo_validacion_key" ON "Pago"("codigo_validacion");
...
-- AddForeignKey
ALTER TABLE "Responsabilidad" ADD CONSTRAINT "Responsabilidad_id_relacion_fkey" FOREIGN KEY ("id_relacion") REFERENCES "Relacion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RamaAfectada" ADD CONSTRAINT "RamaAfectada_id_evento_fkey" FOREIGN KEY ("id_evento") REFERENCES "Evento"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RamaAfectada" ADD CONSTRAINT "RamaAfectada_id_rama_fkey" FOREIGN KEY ("id_rama") REFERENCES "Rama"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Pago" ADD CONSTRAINT "Pago_id_concepto_pago_fkey" FOREIGN KEY ("id_concepto_pago") REFERENCES "ConceptoPago"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Pago" ADD CONSTRAINT "Pago_id_cuenta_origen_fkey" FOREIGN KEY ("id_cuenta_origen") REFERENCES "CuentaDinero"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CuentaDinero" ADD CONSTRAINT "CuentaDinero_id_area_fkey" FOREIGN KEY ("id_area") REFERENCES "Area"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CuentaDinero" ADD CONSTRAINT "CuentaDinero_id_rama_fkey" FOREIGN KEY ("id_rama") REFERENCES "Rama"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CuentaDinero" ADD CONSTRAINT "CuentaDinero_id_miembro_fkey" FOREIGN KEY ("id_miembro") REFERENCES "Miembro"("id") ON DELETE SET NULL ON UPDATE CASCADE;
